                            ...
                            <x-slot name="form">
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    ...
                                    <x-input id="skillName" class="w-full" type="text" name="name"
                                        x-model="skill.name" value="{{ old('name') }}" placeholder="Input skill name" required />
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    ...
                                    <x-text-area id="skillDescription" class="w-full  border-gray-500 border-2 rounded-sm " name="description" rows="3"
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    ...
                                    <select id="skillCategory"  class="w-full border-gray-500 border-2 rounded-sm appearance-none " name="category_id"
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    ...
                                    <select id="type"  class="w-full border-gray-500 border-2 rounded-sm appearance-none !important "  name="type" x-model="skill.type" required>
