                        ...
                        <x-general.form-section id="addActivity" :submit="route('request-record-activity.store')">
                            <x-slot name="form">
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    ...
                                    <select id="teacherrequest" name="id" style="width: 100%;" class="teacherrequest">
                    ...
                    <x-general.modal :open="'openAddTeacherActivity'" :title="__('Create Activity')">
                        <x-general.form-section id="addActivity" :submit="route('record.store')">
                            <x-slot name="form">
                                ...
                                <div class="col-span-6 sm:col-span-4 w-full">
                                    <x-label for="id" class="w-full" value=" {{ __('Teacher Name') }}" />
                                    <select id="select-teacher" name="id" style="width: 100%;" class="select-teacher">
                                        <option value="">Choose Teacher</option>
                                        @foreach($allTeachers as $teacher)
                                        <option value="{{ $teacher->id }}" {{ request('id') == $teacher->id ? 'selected' : '' }}>
                                            {{ $teacher->name }}
                    ...
                    <table class="table-auto py-10" id="requestactivities">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">{{ $history->category_activity->name ?? 'Not Found' }}</td>
                                <td class="border px-4 py-2 flex flex-row justify-center space-x-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <form action="{{ route('request-record-activity.destroy', $history->id) }}" method="POST" class="inline-block ml-2">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <td class="border">
                                    <div class="flex space-x-3 justify-center">
                                        ...
                                        <form action="{{ route('record.accept', $history->id ) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="bg-green-500 rounded-md px-4 py-2 text-white hover:underline">Accept</button>
                                        </form>

                                        <form action="{{ route('record.decline', $history->id) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('PUT')
